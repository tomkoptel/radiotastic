...
import com.udacity.study.jam.radiotastic.data.cache.db.base.BaseContentProvider;
...
public class AppProvider extends BaseContentProvider {
    ...
    public static final String AUTHORITY = "com.udacity.study.jam.radiotastic.data.cache.db.provider";
